...
export function GlobalLeaderboardTable({ onSelectUser, compact = false }: GlobalLeaderboardTableProps) {
    const { t } = useTranslation()
    const { overviewData, fetchOverview, isLoadingOverview } = useAdminStats()
